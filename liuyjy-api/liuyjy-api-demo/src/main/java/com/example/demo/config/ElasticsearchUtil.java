...
public class ElasticsearchUtil {
    ...
    // 创建mapping
    public static XContentBuilder createMapping(String index, String type) {
    ...
    public static boolean createIndex(String index, String type) {
        ...
        XContentBuilder mapping = createMapping(index, type);
        ...
        if (!response.isAcknowledged()) {
            System.out.println("Could not define mapping for type [" + index + "]/[" + type + "].");
        } else {
     ...
     * @return
     */
    public static SearchRequestBuilder searchData(String index, String type) {

        SearchRequestBuilder getRequestBuilder = client.prepareSearch(index).setTypes(type);
